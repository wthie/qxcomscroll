...
//Special attention should be paid to the function ready which should be overridden in
//almost every case, working with the widgetready function in a closure. widgetready
//could of call another method func in the class but practice shows, that the point of
//being informed that we're setup properly for action is way to important to delegate
//it into superclass. Think of ready as a stub, which is more like a template to start
//work on your own widgets implementation

Nevow.Athena.Widget.subclass(qxcomscroll.common.helpers, 'Widget').methods(
  function __init__(self, node) {
    qxcomscroll.common.helpers.Widget.upcall(self, '__init__', node);
  },
...
qxcomscroll.common.helpers.Widget.subclass(qxcomscroll.common.helpers, 'FourOfour').methods(
  function ready(self) {
    function widgetready(res) {
      //do whatever init needs here
    }
